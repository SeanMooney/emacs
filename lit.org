...
#+BEGIN_SRC emacs-lisp
    ...
    (use-package compile
      ...
      :bind (("C-c b" . compile)
             ("C-c B" . recompile)
             ("C-c t" . recompile)) ; Quick test binding
      :custom
...
#+BEGIN_SRC emacs-lisp
  ...
  (use-package eat
    ...
    :bind (("C-c s s" . shell)
           ...
           ("C-c s t" . eat)
           ("C-c s a" . ansi-term)
           ("C-c s p" . eat-project)) ; Project-specific terminal
    :config
...
#+BEGIN_SRC emacs-lisp
  ...
  ;; AI-enhanced development keybindings
  (global-set-key (kbd "C-c a e") #'my/explain-code-with-ai)
  (global-set-key (kbd "C-c a r") #'my/review-code-with-ai)
  (global-set-key (kbd "C-c a d") #'my/document-code-with-ai)
#+END_SRC
